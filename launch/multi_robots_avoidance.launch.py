...
def generate_launch_description():
    ...
    try:
        if 'COLLISION_RADIUS_CHECK_THRESHOLD' in os.environ:
            collision_radius_check_threshold = float(os.environ.get('COLLISION_RADIUS_CHECK_THRESHOLD'))
    ...
    try:
        if 'GLOBAL_POSE_FILTER_THRESHOLD' in os.environ:
            global_pose_filter_threshold = float(os.environ.get('GLOBAL_POSE_FILTER_THRESHOLD'))
